      ...
      describe "Labels" $ do
        ...
        it "Tbl labels" $
          table' "A table" "some_table1"
            ...
            `test` concat (
              [ "\\phantomsection\\label{tbl:some_table1}\n"
              , "\\begin{longtable}[]{@{}@{}}\n"
