...
\begin{subfigure}{0.495\linewidth}\centering\pandocbounded{\includegraphics[keepaspectratio,alt={hidden! subfigure1}]{figs/fig_s2.jpg}}\caption{hidden!
subfigure1\label{fig:fig_sss1}}\end{subfigure}%
\begin{subfigure}{0.495\linewidth}\centering\pandocbounded{\includegraphics[keepaspectratio,alt={hidden! subfigure2}]{figs/fig_s2.jpg}}\caption{hidden!
